...
class CrudTest extends TestCase
{
    ...
    public function test_admin_can_store_section_includes_body(): void
    {
...
本セクションでは...',
    ...
    public function test_admin_can_update_updates_body(): void
    {
        $admin = User::factory()->admin()->create();
    ...
    public function test_preview_returns_html_by_admin(): void
    {
        $admin = User::factory()->admin()->create();
        [$part, $chapter, $section] = $this->makePartChain(Certification::factory()->published()->create(), 'draft');
    ...
    public function test_coach_can_store_section_includes_body(): void
    {
        $admin = User::factory()->admin()->create();
...
本セクションでは...',
    ...
    public function test_coach_can_update_updates_body(): void
    {
        $admin = User::factory()->admin()->create();
        $coach = User::factory()->coach()->create();
        $cert = Certification::factory()->published()->create();
    ...
    public function test_preview_returns_html_by_coach(): void
    {
        $admin = User::factory()->admin()->create();
