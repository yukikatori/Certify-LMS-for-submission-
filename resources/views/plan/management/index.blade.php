{{--
    受講プラン管理の一覧画面（管理者向けマスタ管理）。
    構成: 見出し + 新規作成ボタン → 検索/ステータス絞り込みフォーム → プラン一覧テーブル（0 件時は空状態）→ ページネーション。
...
@section('content')
    ...
    <x-card class="mt-6" padding="sm" shadow="sm">
        <form novalidate method="GET" action="{{ route('admin.plans.index') }}" class="grid gap-3 sm:grid-cols-[1fr_180px_auto]">
            <div class="relative">
